...
pub struct Invoice {
    ...
    pub due_date: u64,
    pub status: u64, // Using u64 instead of InvoiceStatus enum
...
impl InvoiceContract {
    ...
    pub fn settle_invoice(env: Env, invoice_id: u64) {
        ...
        if invoice.status != 1 { // Not Funded
